...
import main.java.lnegrini.dao.VendaJpaDAO;
...
import main.java.lnegrini.mock.VendaExclusaoJpaDAO;
...
public class VendaJpaDaoTest {
    ...
    @Before
    public void init() throws TipoChaveNaoEncontradaException, MaisDeUmRegistroException, TabelaException, DAOException {
    ...
    @Test
    public void pesquisar() throws TipoChaveNaoEncontradaException, MaisDeUmRegistroException, TabelaException, DAOException {
    ...
    @Test
    public void salvar() throws TipoChaveNaoEncontradaException, DAOException, MaisDeUmRegistroException, TabelaException {
    ...
    @Test
    public void cancelarVenda() throws TipoChaveNaoEncontradaException, MaisDeUmRegistroException, TabelaException, DAOException {
    ...
    @Test
    public void adicionarMaisProdutosDoMesmo() throws TipoChaveNaoEncontradaException, MaisDeUmRegistroException, TabelaException, DAOException {
    ...
    @Test
    public void adicionarMaisProdutosDiferentes() throws TipoChaveNaoEncontradaException, MaisDeUmRegistroException, TabelaException, DAOException {
    ...
    @Test
    public void removerProduto() throws TipoChaveNaoEncontradaException, MaisDeUmRegistroException, TabelaException, DAOException {
    ...
    @Test
    public void removerApenasUmProduto() throws TipoChaveNaoEncontradaException, MaisDeUmRegistroException, TabelaException, DAOException {
    ...
    @Test
    public void removerTodosProdutos() throws TipoChaveNaoEncontradaException, MaisDeUmRegistroException, TabelaException, DAOException {
    ...
    @Test
    public void finalizarVenda() throws TipoChaveNaoEncontradaException, MaisDeUmRegistroException, TabelaException, DAOException {
    ...
    public void tentarAdicionarProdutosVendaFinalizada() throws TipoChaveNaoEncontradaException, MaisDeUmRegistroException, TabelaException, DAOException {
    ...
    private ProdutoJpa cadastrarProduto(String codigo, BigDecimal valor) throws TipoChaveNaoEncontradaException, MaisDeUmRegistroException, TabelaException, DAOException {
