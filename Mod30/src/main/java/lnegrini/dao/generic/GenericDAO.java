...
import main.java.lnegrini.exceptions.*;
...
import java.util.List;
    ...
    public abstract class GenericDAO<T extends Persistente, E extends Serializable> implements IGenericDAO<T,E> {
        ...
        private Long validarMaisDeUmRegistro(E valor) throws MaisDeUmRegistroException, TabelaException, TipoChaveNaoEncontradaException, DAOException {
            Connection connection = getConnection();
            PreparedStatement stm = null;
            ResultSet rs = null;
            Long count = null;
        ...
        private String getTableName() throws TabelaException {
            if (getTipoClasse().isAnnotationPresent(Tabela.class)) {
                Tabela table = getTipoClasse().getAnnotation(Tabela.class);
                return table.value();
            }else {
                throw new TabelaException("TABELA NO TIPO " + getTipoClasse().getName() + " NÃO FOI ENCONTRADA");
            }
        }
        ...
        public Collection<T> buscarTodos() throws DAOException {
            ...
            } catch (SQLException | InstantiationException | IllegalAccessException | IllegalArgumentException | InvocationTargetException | NoSuchMethodException | SecurityException | TabelaException e) {
                throw new DAOException("ERRO LISTANDO OBJETOS ", e);
            } finally {
                closeConnection(connection, stm, rs);
            }
