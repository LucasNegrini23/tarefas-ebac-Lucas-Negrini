...
import main.java.lnegrini.dao.factory.ProdutoQuantidadeFactory;
import main.java.lnegrini.dao.factory.VendaFactory;
import main.java.lnegrini.dao.generic.GenericDAO;
import main.java.lnegrini.domain.ProdutoQuantidade;
...
import static main.java.lnegrini.dao.generic.jdbc.ConnectionFactory.getConnection;
...
public class VendaDAO extends GenericDAO<Venda, String> implements IVendaDAO {
    ...
    @Override
    public Venda consultar(String valor) throws MaisDeUmRegistroException, TabelaException, DAOException {
...
//		return venda;
    ...
    private StringBuilder sqlBaseSelect() {
        ...
        sb.append("C.ID AS ID_CLIENTE, C.NOME, C.CPF, C.TEL, C.ENDERECO, C.NUMERO, C.CIDADE, C.ESTADO, C.ESTADOCIVIL ");
